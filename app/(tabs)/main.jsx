...
export default function translation() {
  ...
  //   Outfit: require(''), // Update with the correct path to the font
  // });
  ...
  // if (!fontsLoaded) {
  //   return <AppLoading />; // You can return null or a loading component
  // }
  ...
  return (
    ...
    <View>
      ...
      {/* style={{fontSize:30,fontFamily:'outfit'}} */}
 ...
 <View style={styles.content}>
   <View style={styles.box}>
    ...
    <Text style={styles.boxText}>To Record</Text>  */}
 {/* <Text style={styles.label}>Enter The text here: {}</Text> */}
 <TextInput
...
<Image
  ...
  <View style={styles.box}>
      <Text style={{bottom:90,right:110}} >
        {IsselectedLanguage}
      </Text>
<TouchableOpacity style={styles.speaker} onPress={() => alert(' speaker Pressed!')}>
      <Image 
          source={require('../speaker.jpg')} 
        />
        </TouchableOpacity>
{/*     
    <Text style={styles.boxText}>Press & Hold</Text>
